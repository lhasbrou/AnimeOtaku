...
<a href="../index.html" onMouseUp="MM_swapImgRestore()" onMouseOver="MM_swapImage('Home','','../IMGS/HomeHover.png',1)" onMouseOut="MM_swapImgRestore()" onMouseDown="MM_swapImage('Home','','../IMGS/HomeDown.png',1)"><img src="../IMGS/Home.png" name="Home" border="0"></a><br>
...
search_database($searchvalue, $mysqli);
