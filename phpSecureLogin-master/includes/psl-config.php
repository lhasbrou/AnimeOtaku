 ...
 */
define("HOST", "mysql.binhoster.com"); 			// The host you want to connect to. 
define("USER", "u595614421_otaku"); 			// The database username. 
define("PASSWORD", "qwertyNemeRulez!1"); 	// The database password. 
define("DATABASE", "u595614421_anime");             // The database name.
